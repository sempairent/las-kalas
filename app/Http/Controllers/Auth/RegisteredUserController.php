...
class RegisteredUserController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        $request->validate([
            ...
            'departamento' => 'required|string|max:15|regex:/^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+$/',
            'provincia' => 'required|string|max:15|regex:/^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+$/',
            'distrito' => 'required|string|max:15|regex:/^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+$/',
