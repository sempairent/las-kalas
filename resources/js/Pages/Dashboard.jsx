                        ...
                        <div className="items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4 rtl:space-x-reverse">
                            <a href="#" className="w-full sm:w-15 bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-8 py-4 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
                                ...
                                <div class="text-left rtl:text-right">
                                    ...
                                    <div class="-mt-1 font-sans text-sm font-semibold">Consulta médica</div>
                                </div>
                            </a>
                            <a href="#" class="w-full sm:w-15 bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-8 py-4 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
                                
                                <div class="text-left rtl:text-right">
                                    
                                    <div class="-mt-1 font-sans text-sm font-semibold ">Mis citas</div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div className="items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4 rtl:space-x-reverse">
                            <a href="#" className="w-full sm:w-15 bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-8 py-4 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
                                ...
                                <div class="text-left rtl:text-right">
                                    ...
                                    <div class="-mt-1 font-sans text-sm font-semibold">Prescripciones médicas</div>
                                </div>
                            </a>
                            <a href="#" class="w-full sm:w-15 bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-8 py-4 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
                                ...
                                <div class="text-left rtl:text-right">
                                    ...
                                    <div class="-mt-1 font-sans text-sm font-semibold">Registrar nueva cita</div>
                                </div>
                            </a>
                        </div>
                        <br /><br /><br />
